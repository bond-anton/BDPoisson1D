...
setup(
    ...
    setup_requires=['numpy', 'Cython', 'scipy>=0.17.0', 'BDMesh>=0.2.11', 'BDFunction1D>=0.0.4'],
    install_requires=['numpy', 'scipy>=0.17.0', 'matplotlib', 'BDMesh>=0.2.11', 'BDFunction1D>=0.0.4'],
